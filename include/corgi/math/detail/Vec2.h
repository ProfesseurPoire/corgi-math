...
public:
    ...
    constexpr bool operator!=(const vec2& v) const noexcept { return !operator==(v); }
    ...
    segment_intersect(vec2 a, vec2 b, vec2 c, vec2 d, vec2& intersection)
    {
    ...
    /*!
			 ...
			 */
    [[nodiscard]] constexpr ValueType* array() const noexcept { return &x; }
    ...
    [[nodiscard]] vec2 range(ValueType range_angle)
    {
        ...
        current_angle += -range_angle + static_cast<ValueType>(::rand()) /
